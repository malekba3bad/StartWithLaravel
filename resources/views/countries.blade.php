...
<h1 style="text-align:center">Flights</h1>
    <a href="{{route('country.create')}}" class="button">add flight</a>
  ...
  @if(@isset($data) and !@empty($data))
    @foreach($data as $info)
        <tr>
            ...
            <td><a href="{{ route('country.edit', $info->id) }}" class="button" style="background-color: #04AA6D; border-radius: 5px;">edit</a></td>
